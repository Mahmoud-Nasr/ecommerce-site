...
<html>
    ...
    <body>
        ...
        try{
            ...
            if(string.booleanValue()==true)
            { 
                session.setAttribute("source", "remove_cat");
                        ...
                        <div class="menu"> 	
                            <div class="top-nav"> 
                                <ul>
                                    ...
                                    <li class="active"><a href="remove_cat.jsp">remove categories</a></li>
                                ...
                                <div class="header_bottom_right_images">
                                        <div class="content-wrapper">
                                            ...
                                            <form action="../servlet" method="POST">
                                                ...
                                                <input type="number" name="username" value="" required="true"/><br/>

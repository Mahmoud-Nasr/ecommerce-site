...
<html>
    ...
    <body>
        ...
        <%  
            try{
       Integer  string=(Integer) session.getAttribute("currentuserid");
                        ...
                        <div class="menu"> 	
                            <div class="top-nav"> 
                                <ul>
                                    ...
                                    <li class="active"><a href="remove_item.jsp">remove Item</a></li>
                                ...
                                <div class="header_bottom_right_images">
                                        <div class="content-wrapper">
                                            ...
                                            <form action="../servlet" method="POST">
                                                ...
                                                <input type="text" name="username" value="" required="true"/><br/>

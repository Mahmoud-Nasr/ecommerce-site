...
<html>
    ...
    <body>
        ...
        <% 
        session.setAttribute("source", "new_admin");
        %>
        <div class="header-bg">
            <div class="wrap"> 
                <div class="h-bg">
                        ...
                        <div class="banner-top">
                            <div class="header-bottom">
                                        ...
                                        <div class="content-top">
                                            ...
                                            <div class="text"> 
                                                ...
                                                <div class="grid_1_of_3 images_1_of_3">
                                                    <div class="grid_1">
                                                        <a href="single.jsp"><img src="images/pic12.jpg" title="continue reading" alt=""></a>
                                                        <div class="grid_desc">
                                ...
                                <div class="footer-bottom">
                                    <div class="copy">
                                        <p>All rights Reserved | Design by <a href="">Elmnofy Team</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
